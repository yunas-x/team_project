...
def parse(folder_with_pdf_files_path: str, folder_to_save_json_files_path: str, parser: ParserProtocol, process_count: int = 12):
...
def __parse(all_file_names: list[str], pdf_folder_path: str, folder_to_save_json_files_path: str, parser: ParserProtocol):
    """Parse pdf files and save resulting json files. If path to json-schema is specified, validation will be performed
    ...
    Args:
        ...
        json_schema_full_path (Optional[str], optional): Path to json-schema
    """
...
def validate(folder_with_pdf_files_path: str, folder_to_save_json_files_path: str, json_schema_full_path: str, process_count: int = 12):
    pdf_folder_path = Path(folder_with_pdf_files_path)
    all_file_names = [full_file_name.name for full_file_name in list(pdf_folder_path.iterdir())]
