...
class InfographicsProgramIDs(BaseModel):
    first_program_id: PositiveInt
    second_program_id: PositiveInt
...
class Infographics(BaseModel):
   ...
   first_program_lesson_hours_a_week: Annotated[list[PositiveInt], Len(min_length=2, max_length=6)]
   second_program_lesson_hours_a_week: Annotated[list[PositiveInt], Len(min_length=2, max_length=6)]